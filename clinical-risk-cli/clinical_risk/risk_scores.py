...
# purpose: qsofa score accepts RR, SPB, and altered mental status and calculates the qsofa score.
# ins& outs: rr (respiratory rate) (int), sbp (int), ams (bool) -> score (int)
