...
class TestQSOFA(unittest.TestCase):
    ...
    def test_all_criteria_met(self):
        # TODO: Write a unittest case where rr is greater than or equal to 22, sbp is less than 100, and ams is true the score is 3.
    ...
    def test_partial_criteria(self):
        ...
        self.assertEqual(qsofa_score(rr=18, sbp=90, ams=True), 1)
